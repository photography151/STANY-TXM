...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/Stanking11/STANY-TXM.git';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://i.ibb.co/wF6ZMYgx/shaban-md.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'Stany tech',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
